...
class SubforumMainPage extends StatefulWidget {
  @override
  State<SubforumMainPage> createState() => _SubforumMainPage();
}

class _SubforumMainPage extends State<SubforumMainPage> {
  late bool isAdmin;
  late User user;
